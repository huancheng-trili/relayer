...
contract GatewayContract {
    ...
    */
    ...
    function completeIntent(Actions action, string memory asset, string memory network, address payable destAddr, bytes calldata proof) public {
        (bool success, ) = destAddr.call{value: 100 gwei}("");
